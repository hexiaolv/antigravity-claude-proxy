...
window.translations.id = {
    ...
    quotaCycle: "Siklus Kuota",
    geminiModels: "Model Gemini",
    claudeGptModels: "Model Claude dan GPT",
    weeklyLimitRemaining: "Sisa Kuota Mingguan",
    fiveHourLimitRemaining: "Sisa Kuota 5 Jam",
    geminiModelsDesc: "Model dalam grup ini: Gemini Flash, Gemini Pro",
    claudeGptModelsDesc: "Model dalam grup ini: Claude Opus, Claude Sonnet, GPT-OSS",
