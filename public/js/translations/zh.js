...
window.translations.zh = {
    ...
    globalQuota: "全局配额",
    nextReset: "重置时间",
    globalOverview: "全局汇总概览",
    categoryCardsView: "分类卡片",
    detailTableView: "单模型列表",
    earliestRefresh: "最快刷新",
    weeklyLimitRemaining: "Weekly Limit Remaining",
    fiveHourLimitRemaining: "Five Hour Limit Remaining",
    perAccountBreakdown: "各账号配额明细",
    viewAccountModels: "单模型明细",
    distribution: "账号分布",
    systemConfig: "系统配置",
    language: "语言设置",
    theme: "外观主题",
    ...
    claudeGptModels: "Claude 和 GPT 模型",
    weeklyLimitRemaining: "周配额剩余",
    fiveHourLimitRemaining: "5 小时配额剩余",
    geminiModelsDesc: "此组包含的模型：Gemini Flash, Gemini Pro",
    claudeGptModelsDesc: "此组包含的模型：Claude Opus, Claude Sonnet, GPT-OSS",
    selectAccount: "选择账号",
    filter: "筛选",
    all: "全选",
    none: "清空",
    ...
    // 类别配额视图
    categoryCardsView: "分类卡片",
    detailTableView: "模型明细表",
    globalQuotaPool: "全局配额总池",
    globalPoolBadge: "全系统聚合",
    globalPoolSubtitle: "跨所有已激活账号的聚合平均配额与最快刷新预测",
    effectiveAccounts: "{count} 个有效账号",
    fiveHourLimit: "5小时限额",
    weeklyLimit: "周限额",
    fastestRefresh: "最快回血刷新",
    weeklyReset: "最快周期刷新",
    perAccountBreakdown: "各账号独立配额",
    accountsCountBadge: "{count} 个独立账号",
    healthyAccounts: "{healthy}/{total} 正常",
    accountNode: "账号节点",
    viewAccountModels: "查看模型",
    ...
    debugModeToggled: "调试模式已切换",
    tokenCacheToggled: "令牌缓存已切换",
    ...
    failedToReloadAccounts: "重新加载账号失败",
    failedToUpdateModelConfig: "更新模型配置失败",
    fieldUpdated: "字段已更新",
    failedToUpdateField: "更新字段失败",
    mustBeValidNumber: "必须为有效数字",
    mustBeAtLeast: "不能小于 {min}",
    mustBeAtMost: "不能大于 {max}",
    cannotBeEmpty: "不能为空",
    mustBeTrueOrFalse: "必须为 true 或 false",

    // 新增视图与组件词条
    languageAuto: "跟随系统 (Auto)",
    realtimeSystem: "全系统实时",
    globalQuotaPoolTitle: "全局配额总池与大类聚合",
    activeAccountsColon: "有效账号:",
    earliestResetColon: "最快回血:",
    weeklyResetColon: "周期刷新:",
    healthScore: "健康分",
    accountQuotaBreakdown: "各账号独立配额概览",
    totalAccountsCount: "共 {count} 个账号",
    accountQuotasAndReset: "各账号配额与刷新明细",
    averageColon: "均值 {pct}%",
    fiveHourColon: "5H:",
    weekColon: "周:",
    pinModel: "置顶模型",
    ...
    loadingEllipsis: "加载中...",
    moreAccounts: "个更多账号...",
    filterThisAccount: "只看此账号",
    resetPrefix: "⚡ 回血: ",
    ready5H: "5H 就绪",
    weeklyPrefix: "📅 刷新: ",
    showingModels: "显示模型: {count} 个",
    showModelsTable: "展开模型列表",
    hideModelsTable: "收起模型列表"
};
