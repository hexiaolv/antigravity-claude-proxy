...
window.translations.en = {
    ...
    categoryCardsView: "Category Cards",
    detailTableView: "Models Table",
    earliestRefresh: "Earliest Refresh",
    weeklyLimitRemaining: "Weekly Limit Remaining",
    fiveHourLimitRemaining: "Five Hour Limit Remaining",
    perAccountBreakdown: "Per-Account Breakdown",
    viewAccountModels: "Account Models",
    ...
    claudeGptModels: "Claude and GPT models",
    weeklyLimitRemaining: "Weekly Limit Remaining",
    fiveHourLimitRemaining: "Five Hour Limit Remaining",
    geminiModelsDesc: "Models within this group: Gemini Flash, Gemini Pro",
    claudeGptModelsDesc: "Models within this group: Claude Opus, Claude Sonnet, GPT-OSS",
    ...
    categoryCardsView: "Category Cards",
    detailTableView: "Models Table",
    globalQuotaPool: "Global Quota Pool",
    globalPoolBadge: "System Aggregate",
    globalPoolSubtitle: "Aggregate average quota and fastest refresh countdown across all active accounts",
    effectiveAccounts: "{count} active accounts",
    fiveHourLimit: "5-Hour Limit",
    weeklyLimit: "Weekly Limit",
    fastestRefresh: "Fastest Refresh",
    weeklyReset: "Weekly Reset",
    perAccountBreakdown: "Per-Account Breakdown",
    accountsCountBadge: "{count} Isolated Accounts",
    healthyAccounts: "{healthy}/{total} Healthy",
    accountNode: "Account Node",
    viewAccountModels: "View Models",

    // Added view keys
    languageAuto: "Follow System (Auto)",
    realtimeSystem: "System Realtime",
    globalQuotaPoolTitle: "Global Quota Pool & Category Aggregate",
    activeAccountsColon: "Active Accounts:",
    earliestResetColon: "Fastest Reset:",
    weeklyResetColon: "Weekly Reset:",
    healthScore: "Health Score",
    accountQuotaBreakdown: "Per-Account Quota Breakdown",
    totalAccountsCount: "{count} Total Accounts",
    accountQuotasAndReset: "Account Quotas & Reset Details",
    averageColon: "Avg {pct}%",
    fiveHourColon: "5H:",
    weekColon: "Week:",
    pinModel: "Pin model",
    ...
    manualReload: "Reload Accounts",
    filterThisAccount: "Filter Account",
    resetPrefix: "⚡ Reset: ",
    ready5H: "5H Ready",
    weeklyPrefix: "📅 Weekly: ",
    showingModels: "Showing: {count} Models",
    showModelsTable: "Show Models List",
    hideModelsTable: "Hide Models List"
};
